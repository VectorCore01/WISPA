...
import { genSeed, genWispId, genMsgKey, genHiveId } from "../../lib/crypto/id.js";
import { capPerSender, CELL_MSG_PER_SENDER } from "../../lib/utils/cell.js";
import { nowTime } from "../../lib/utils/time.js";
import { seedCells, seedHiveMembers } from "../../lib/crypto/seed.js";
import { lookupPeer } from "../../lib/data/directory.js";
import { loadSession, saveSession, clearSession } from "../../lib/utils/session.js";
import { t } from "../../lib/data/translations.js";
import { api, normCell } from "../../lib/api/api.js";
import { useHoney } from "../../lib/hooks/useHoney.js";
import Landing from "../calculator/Landing.jsx";
import WispLanding from "../animations/WispLanding.jsx";
import EntryChoice from "../auth/EntryChoice.jsx";
import Profile from "../auth/Profile.jsx";
import Onboard from "../auth/Onboard.jsx";
import Login from "../auth/Login.jsx";
import AppShell from "./AppShell.jsx";
import IntroOverlay from "../animations/IntroOverlay.jsx";
...
export default function WispaPrototype() {
  ...
  // The reveal now lives entirely on the calculator: it fades out, the grey
  // honeycomb ignites, and only then does this fire — so we just swap to WISPA.
  function runUnlockBurst(after) { after(); }
  ...
  return (
    <div className="app-root" style={{
      ...
      {visor ? (
        <Landing C={C} mode={mode} toggleMode={toggleMode} onUnlock={calcUnlock} onReset={() => resetAccess(true)} expectedCode={vaultCode} returning />
      ) : screen === "landing" ? (
        <Landing C={C} mode={mode} toggleMode={toggleMode} onUnlock={calcUnlock} onReset={() => resetAccess(true)} expectedCode={vaultCode} />
      ) : screen === "wisp-landing" ? (
